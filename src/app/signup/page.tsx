...
import { Link2, Linkedin, Github, Loader2, AlertTriangle, ChevronsUpDown, Check, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="relative flex min-h-screen items-center justify-center p-4">
      ...
      <Card className="w-full max-w-2xl mx-auto my-8">
        <CardHeader className="space-y-1 text-center"><div className="flex items-center justify-center gap-2">
          ...
          <CardDescription>Create an account to connect with peers</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-6 pt-4 border-t">
                <h3 className="text-lg font-medium">{role === 'student' ? 'Student' : 'Alumni'} Profile</h3>
                {role === 'alumni' && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
